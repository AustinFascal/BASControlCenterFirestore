...
public class AddSplrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_splr);
        ...
        databaseReference.child("BankData").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(AddSplrActivity.this, R.layout.style_spinner, bankList);
    ...
    private void insertData(String bankName, String bankAccountOwnerName, String bankAccountNumber,
        ...
        SplrModel splrModel = new SplrModel(supplierDocumentID,
                bankName, bankAccountOwnerName, bankAccountNumber, supplierPhoneNumber,
                supplierPayeeName, supplierName, true);


        refSupplier.set(splrModel)
                .addOnSuccessListener(unused -> {
                    dialogInterfaceUtils.savedInformationFromManagement(AddSplrActivity.this);
                }).addOnFailureListener(e ->
                        Toast.makeText(AddSplrActivity.this, "FAILED", Toast.LENGTH_SHORT).show());
