...
public class AddRcpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_rcp);
        ...
        pd = new ProgressDialog(AddRcpActivity.this);
        ...
        btnExitSelection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                menu.findItem(R.id.select_all_data_recap).setIcon(ContextCompat.getDrawable(AddRcpActivity.this, R.drawable.ic_outline_select_all));
        ...
        edtDateStart.setOnClickListener(view -> {
            ...
            datePicker = new DatePickerDialog(AddRcpActivity.this,
                ...
                if (value != null) {
                    if (!value.isEmpty()) {
                        for (DocumentSnapshot d : value.getDocuments()) {
                            ...
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(AddRcpActivity.this, R.layout.style_spinner, customerList);
                                    ...
                                    db.collection("ReceivedOrderData").whereEqualTo("custDocumentID", custDocumentID)
                                            .addSnapshotListener((value, error) -> {
                                                if (!Objects.requireNonNull(value).isEmpty()) {
                                                    ...
                                                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(AddRcpActivity.this, R.layout.style_spinner, receiveOrderNumberList);
                                                    arrayAdapter.setDropDownViewResource(R.layout.style_spinner);
        ...
        btnSearchData.setOnClickListener(view -> {
            ...
            View viewLayout = AddRcpActivity.this.getCurrentFocus();
            if (viewLayout != null) {
                InputMethodManager imm = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(viewLayout.getWindowToken(), 0);
            }
        ...
        fabCreateGiRecap.setOnClickListener(view -> {
            if (ContextCompat.checkSelfPermission(context,
                ...
                dialogInterfaceUtils.confirmCreateRecap(context, rcpGiUID, coDateCreated + " " + coTimeCreated, helperUtils.getUserId(), roDocumentID, roPoCustNumber, rcpDateDeliveryPeriod, totalUnit, giModelArrayList);
            }
        });
    ...
    private void addGiRcpMainContent(Document document) throws DocumentException{
        ...
        try {
            ...
            for (int i = 0; i < giDataAdapter.getSelected().size(); i++){
                ...
                String rowIDStrVal = giDataAdapter.getSelected().get(i).getGiNoteNumber();
        ...
        db.collection("ReceivedOrderData").whereEqualTo("roPoCustNumber", pouidVal).get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots){
                        ...
                        roPoCustNumber = roModel.getRoPoCustNumber();
                        String custDocumentID = roModel.getCustDocumentID();
