...
public class UpdateRecapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtDatePaid.setOnClickListener(view -> {
            ...
            datePicker = new DatePickerDialog(UpdateRecapActivity.this,
    ...
    private void addInvMainContent(Document document) throws DocumentException{
        try {
            ...
            /*tblInvSection11.addCell(cellTxtNoBrdrNrml(
                    ...
                    Element.ALIGN_LEFT));*/
            tblInvSection11.addCell(cellTxtNoBrdrNrml(
                    new Paragraph(NumberToWords.convert(Long.parseLong(dfRound1.format(totalDueDefault)))+" Rupiah", fontMedium),
                    Element.ALIGN_LEFT));
            tblInvSection11.addCell(cellTxtNoBrdrNrml(
                    new Paragraph("", fontMediumWhite),
                    Element.ALIGN_LEFT));
