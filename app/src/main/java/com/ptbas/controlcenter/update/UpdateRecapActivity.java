...
import com.ptbas.controlcenter.databinding.ActivityUpdateRecapBinding;
...
public class UpdateRecapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceProfile.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(UpdateRecapActivity.this, "Terjadi kesalahan.", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            refRecap.whereEqualTo("rcpGiDocumentID", rcpDocumentID).get()
                    .addOnSuccessListener(queryDocumentSnapshots -> {
                        for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots){
                            ...
                            rcpDateDeliveryPeriod = recapGIModel.getRcpDateDeliveryPeriod();
                            rcpGiCreatedByUserID = recapGIModel.getRcpGiCreatedBy();
                            String rcpGiDateAndTimeCreated = recapGIModel.getRcpGiDateAndTimeCreated();
                            String roDocumentID = recapGIModel.getRoDocumentID();
                            double roCubication = recapGIModel.getRcpGiCubication();
    ...
    private void addGiRcpMainContent(Document document) throws DocumentException{
        ...
        try {
            ...
            for (int i = 0; i < goodIssueModelArrayList.size(); i++){
                ...
                String rowIDStrVal = goodIssueModelArrayList.get(i).getGiNoteNumber();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.itemMenuPrint){
            if (ContextCompat.checkSelfPermission(context,
                ...
                dialogInterface.confirmCreateRecapFromUpdate(context, rcpDocumentID, rcpDateDeliveryPeriod, helper.getUserId(), roDocumentID, roPoCustNumber, rcpDateDeliveryPeriod, df.format(totalUnitFinal), goodIssueModelArrayList);
