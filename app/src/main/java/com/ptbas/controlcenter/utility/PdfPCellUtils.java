...
public class PdfPCellUtils {

    public void addPdfTitle(Document document, String documentTitle, Font font, Integer spacingAfter) throws DocumentException {
        Paragraph preface1 = new Paragraph();
        Chunk title = new Chunk(documentTitle, font);
    ...
    public static PdfPCell cellTxtBrdrNrml(Paragraph paragraph, int alignment) {
        paragraph.setAlignment(alignment);
        paragraph.setLeading(0, 1);
        PdfPCell cell = new PdfPCell();
        cell.addElement(paragraph);
