        ...
        firebaseAuth.createUserWithEmailAndPassword(txtEmail, txtPass).addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    UserDetails userDetails = new UserDetails(txtDob, txtGender, txtMobile, txtAccessCode);
                    ...
                    referenceProfile.child(Objects.requireNonNull(firebaseUser).getUid()).setValue(userDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
