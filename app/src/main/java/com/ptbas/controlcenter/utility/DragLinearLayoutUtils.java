...
public class DragLinearLayoutUtils extends LinearLayout {
    private static final String LOG_TAG = DragLinearLayoutUtils.class.getSimpleName();
    ...
    public DragLinearLayoutUtils(Context context) {
        this(context, null);
    }

    public DragLinearLayoutUtils(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        dragBottomShadowDrawable = ContextCompat.getDrawable(context, R.drawable.divider_transparent);
