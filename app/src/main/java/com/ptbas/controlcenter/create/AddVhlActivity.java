...
public class AddVhlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_vhl);
        ...
        dbRefVehicleBrand.child("VehicleBrand").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(AddVhlActivity.this, R.layout.style_spinner, vhlBrandList);
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    try{
                        ...
                        Toast.makeText(AddVhlActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        BottomSheetMaterialDialog mBottomSheetDialog = new BottomSheetMaterialDialog.Builder(this)
                ...
                .setNegativeButton("TIDAK", R.drawable.ic_outline_close, new BottomSheetMaterialDialog.OnClickListener() {
                    ...
                    public void onClick(dev.shreyaspatil.MaterialDialog.interfaces.DialogInterface dialogInterface, int which) {
                        dialogInterface.dismiss();
                        finish();
                        helperUtils.refreshDashboard(AddVhlActivity.this);
                    }
    ...
    public void onBackPressed() {
        helperUtils.refreshDashboard(this);
    }
