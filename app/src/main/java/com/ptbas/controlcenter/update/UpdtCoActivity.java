...
public class UpdtCoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updt_co);
       ...
       // nestedScrollView = findViewById(R.id.nestedScrollView);
        ...
        edtDatePaid.setOnClickListener(view -> {
            ...
            datePicker = new DatePickerDialog(UpdtCoActivity.this,
                ...
                .addSnapshotListener((value, error) -> {
                    ...
                    if (value != null) {
                        if (!value.isEmpty()) {
                            ...
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(UpdtCoActivity.this, R.layout.style_spinner, bankAccount);
                            arrayAdapter.setDropDownViewResource(R.layout.style_spinner);
                            spinnerBankAccount.setAdapter(arrayAdapter);
                        } else {
                            Toast.makeText(UpdtCoActivity.this, "Not exists", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                .addSnapshotListener((value, error) -> {
                    ...
                    if (value != null) {
                        if (!value.isEmpty()) {
                            ...
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(UpdtCoActivity.this, R.layout.style_spinner, supplierName);
                            arrayAdapter.setDropDownViewResource(R.layout.style_spinner);
        ...
        spinnerSupplierName.setOnItemClickListener((adapterView, view, i, l) -> {
            View viewLayout = UpdtCoActivity.this.getCurrentFocus();
            if (viewLayout != null) {
        ...
        referenceProfile.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(UpdtCoActivity.this, "Terjadi kesalahan.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fabPrint.setOnClickListener(view -> {
            if (ContextCompat.checkSelfPermission(context,
                ...
                dialogInterfaceUtils.confirmPrintCo(context, db, giModelArrayList,
            ...
            refCO.whereEqualTo("coDocumentID", coID).get()
                    .addOnSuccessListener(queryDocumentSnapshots -> {
                        for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots){
                            ...
                            coUIDVal = coModel.getCoUID();
                            coCreatedBy = coModel.getCoCreatedBy();
                            coApprovedBy = coModel.getCoApprovedBy();
                            coAccBy = coModel.getCoAccBy();
                            tvCoUID.setText(coUIDVal);

                            edtBookedStep1By.setText(coModel.getCoBookedStep1By());
                            edtBookedStep2By.setText(coModel.getCoBookedStep2By());
                            edtBookedStep1Date.setText(coModel.getCoBookedStep1Date());
                            edtBookedStep2Date.setText(coModel.getCoBookedStep2Date());
                            bankDocumentID = coModel.getBankDocumentID();

                            edtTransferProofReference.setText(coModel.getCoTransferReference());
                            edtDatePaid.setText(coModel.getCoDateAndTimeACC());




                            coVerifiedBy = coModel.getCoAccBy();
                            bookedStep1By = coModel.getCoBookedStep1By();
                            bookedStep2By = coModel.getCoBookedStep2By();
                            ...
                            statusSwitch.setOnCheckedChangeListener((compoundButton, b) -> {
                                ...
                                if (statusSwitch.isChecked()) {
                                    ...
                                    refCO.document(coID).update("coAccBy", helperUtils.getUserId()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                            ...
                            statusSwitchBookedStep1.setOnCheckedChangeListener((compoundButton, b) -> {
                                ...
                                if (edtBookedStep1Date.getText().toString().isEmpty()){
                                    ...
                                    if (statusSwitchBookedStep1.isChecked()) {
                                        ...
                                        refCO.document(coID).update("coBookedStep1By", helperUtils.getUserId()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()){
                                                    edtBookedStep1Date.setError(null);
                            ...
                            statusSwitchBookedStep2.setOnCheckedChangeListener((compoundButton, b) -> {
                                ...
                                if (edtBookedStep2Date.getText().toString().isEmpty()){
                                    ...
                                    if (statusSwitchBookedStep2.isChecked()) {
                                        ...
                                        refCO.document(coID).update("coBookedStep2By", helperUtils.getUserId()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()){
                                                    edtBookedStep2Date.setError(null);
                            ...
                            coDateAndTimeCreatedVal = coModel.getCoDateAndTimeCreated();
                            tvDateAndTimeCreated.setText(coDateAndTimeCreatedVal);

                            coDateAndTimeApprovedVal = coModel.getCoDateAndTimeApproved();
                            coDateAndTimeAccVal = coModel.getCoDateAndTimeACC();

                            coDateDeliveryPeriodVal = coModel.getCoDateDeliveryPeriod();

                            coPoUIDVal = coModel.getRoDocumentID();
                            ...
                            supplierUID = coModel.getCoSupplier();

                            coStatusApprovalVal = coModel.getCoStatusApproval();
                            coStatusPaymentVal = coModel.getCoStatusPayment();
                                                ...
                                                db.collection("CustomerData").whereEqualTo("custDocumentID", invCustName).get()
                                                        .addOnSuccessListener(queryDocumentSnapshots2 -> {
                                                            for (QueryDocumentSnapshot documentSnapshot2 : queryDocumentSnapshots2){
                                                                ...
                                                                custNameVal = custModel.getCustName();
    ...
    public void createCashOutProofPDF(String dest){
        ...
        try {
            ...
            document.close();
            dialogInterfaceUtils.coPrintedInfo(context, dest);
           ...
           /* List<String> datePeriod = new ArrayList<>();
            ...
            for (String s : deliveryPeriod) {
                ...
                for (int j = 0; j < giModelArrayList.size(); j++) {
                    if (giModelArrayList.get(j).getGiDateCreated().equals(s)) {
